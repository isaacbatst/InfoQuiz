...
<<<<<<< HEAD
-- Host: localhost
-- Tempo de geração: 22/04/2019 às 01:34
...
INSERT INTO `questao` (`id`, `pergunta`, `alternativa_a`, `alternativa_b`, `alternativa_c`, `alternativa_d`, `alternativa_correta`, `disciplina`) VALUES
(2, 'Assinale a opÃ§Ã£o que apresenta o algoritmo de ordenaÃ§Ã£o com o pior desempenho, considerando-se um vetor de 100 elementos, com valores inteiros ordenados em ordem inversa ao do algoritmo de ordenaÃ§Ã£o.', 'shell sort', 'quicksort', 'heapsort', 'bubble sort', 'd', 'Algoritmo'),
(3, 'Considerando A = 10, B = 7 e C = 6, assinale a opÃ§Ã£o correta relacionada Ã  lÃ³gica de programaÃ§Ã£o.', '((B * 4) >= (A + A * 2) AND (5 + 5) >= (A))', '(A + 3) > (B + C)', '((B + A) > (C + C) AND (A ! C) < (B ! A))', '((A + C) < (B * 2) OR (C + B * 3) < (A * 3))', 'd', 'Algoritmo'),
>>>>>>> 758110b37310d86de3a22cf55f1f651136f2dd99
...
(7, 'monic', '1529eb0fadee9d9c50a2308a66648b63');
